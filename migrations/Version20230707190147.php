 ...
 */
final class Version20230707190147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cars_catalogue (id INT AUTO_INCREMENT NOT NULL, picture_cars_catalogue VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE opinion_visitors (opinion_id INT NOT NULL, visitors_id INT NOT NULL, INDEX IDX_8196289651885A6A (opinion_id), INDEX IDX_81962896D475AB2E (visitors_id), PRIMARY KEY(opinion_id, visitors_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cars ADD carscatalogue_id INT NOT NULL, ADD visitors_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cars DROP carscatalogue_id, DROP visitors_id');
